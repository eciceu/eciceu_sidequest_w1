...
<html lang="en">
  <head>
    ...
    <title>Platformer Blob Game</title>
  ...
  <body>
    <script>
      // Y-position of the floor (ground level)good
      let floorY3;
      ...
      function setup() {
        ...
        // Adjust blob properties for frustration
        blob3.gravity = 0.5; // Increase gravity
        blob3.friction = 0.05; // Reduce friction
      }
